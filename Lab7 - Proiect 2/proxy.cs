...
public interface INterface1
{
    ...
    string[] Check([System.ServiceModel.MessageParameterAttribute(Name="check")] string check1, bool silent);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INterface1/Check", ReplyAction="http://tempuri.org/INterface1/CheckResponse")]
    System.Threading.Tasks.Task<string[]> CheckAsync(string check, bool silent);
    ...
    string[] SearchPath(string column, string text);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INterface1/SearchPath", ReplyAction="http://tempuri.org/INterface1/SearchPathResponse")]
    System.Threading.Tasks.Task<string[]> SearchPathAsync(string column, string text);
    ...
    string[] Search(string column, string text);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INterface1/Search", ReplyAction="http://tempuri.org/INterface1/SearchResponse")]
    System.Threading.Tasks.Task<string[]> SearchAsync(string column, string text);
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INterface1/Columns", ReplyAction="http://tempuri.org/INterface1/ColumnsResponse")]
    System.Threading.Tasks.Task<string[]> ColumnsAsync();
...
public partial class Nterface1Client : System.ServiceModel.ClientBase<INterface1>, INterface1
{
    ...
    public string[] Check(string check1, bool silent)
    {
        return base.Channel.Check(check1, silent);
    }
    
    public System.Threading.Tasks.Task<string[]> CheckAsync(string check, bool silent)
    {
    ...
    public string[] SearchPath(string column, string text)
    {
        return base.Channel.SearchPath(column, text);
    }
    
    public System.Threading.Tasks.Task<string[]> SearchPathAsync(string column, string text)
    {
        return base.Channel.SearchPathAsync(column, text);
    }
    
    public string[] Search(string column, string text)
    {
        return base.Channel.Search(column, text);
    }
    
    public System.Threading.Tasks.Task<string[]> SearchAsync(string column, string text)
    {
    ...
    public System.Threading.Tasks.Task<string[]> ColumnsAsync()
    {
